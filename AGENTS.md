...
- Import `roamjs-components` directly. `packages/extension-base` is configuration and a template, not a runtime API.
...
- Never edit generated `dist` files. Build them with pnpm/SamePage.
