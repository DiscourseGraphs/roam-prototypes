/* A source-level guard for a bug this project shipped twice.
 *
 ...
 * load. Named imports are unaffected, which is why the generated template's
 * `{ render }` and `{ runExtension }` work and nothing warns you.
 *
 ...
 * Hence a check on the source text rather than on behavior.
 */
